...
#define HW_CMR_LOG_TAG ""
#endif

#ifndef CMR_LOGI
#define CMR_LOGI(fmt, args...) pr_info("I/[HWCamera] " HW_CMR_LOG_TAG ": " fmt, ##args)
#endif
#ifndef CMR_LOGW
#define CMR_LOGW(fmt, args...) pr_warn("W/[HWCamera] " HW_CMR_LOG_TAG ": " fmt, ##args)
#endif
#ifndef CMR_LOGE
#define CMR_LOGE(fmt, args...) pr_err("E/[HWCamera] " HW_CMR_LOG_TAG ": " fmt, ##args)
#endif
